...
- Mit nötigem Abstand zu Definitionslücken $|g(x)|<|x|$ und $|g(x)|>|g(z_k)|$\\
- Methode \glqq entkommt\grqq\space nicht\\
- Geht, mit nötigem Abstand zu Definitionslücken $|g(x)|<|x|$, näher an die Nullstelle herran\\
\textit{Wie könnte man das zeigen oder was könnte ein Ansatz dazu sein? Falls der Beweis dafür zu komplex wird würde es (denke ich) reichen, wenn ich nur einen groben Ansatz erkläre.}
